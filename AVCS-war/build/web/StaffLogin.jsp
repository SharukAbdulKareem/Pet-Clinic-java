<%-- 
    Document   : StaffLogin
    Created on : Apr 23, 2024, 5:39:58 PM
    Author     : sharuk
--%>
...
<html>
  <head>
    ...
    <style>
      ...
      /* Styles for button */
      .button {
        background-color: #C3DFD6; /* Adjust button color as needed */
        border: none;
        color: black;
        padding: 10px 20px;
        text-align: center;
  ...
  <body>
    <div class="login-container">
      <h1 class="h1">Managing Staff Login</h1>
      ...
      <form action="StaffLogin" method="POST">
        ...
        <br>
        <p>
          If you're a new Staff on Board
          <a href="StaffRegister.jsp" class="link">Register here!</a>
        </p>
      </form>
    </div>
