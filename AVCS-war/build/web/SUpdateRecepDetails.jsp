<%-- 
    Document   : SUpdateRecepDetails
    Created on : Apr 25, 2024, 2:16:08 AM
    Author     : sharuk
--%>
        ...
        <h1>Update Your Details</h1>
                <br><br><br>
                   ...
                   <% 
                                    ...
                                    MyReceptionist reportList = (MyReceptionist) request.getAttribute("receptionistList");
            ...
            <form action="ReceptionistUpdate" method="POST" >
