 ...
 * @author sharuk
 */
@WebServlet(name = "VetDetails1", urlPatterns = {"/VetDetails1"})
public class VetDetails1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                request.getRequestDispatcher("VetsTable.jsp").include(request,response);
