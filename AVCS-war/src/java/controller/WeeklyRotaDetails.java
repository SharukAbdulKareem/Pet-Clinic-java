 ...
 * @author sharuk
 */
@WebServlet(name = "WeeklyRotaDetails", urlPatterns = {"/WeeklyRotaDetails"})
public class WeeklyRotaDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                request.setAttribute("weeklyrotaList", allWeeklyRota);
                request.getRequestDispatcher("WeeklyRotaTable.jsp").include(request,response);
