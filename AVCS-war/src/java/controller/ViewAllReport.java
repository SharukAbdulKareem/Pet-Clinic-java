...
public class ViewAllReport extends HttpServlet {
    ...
    @EJB
    private MyPetReportFacade mPetReportFacade;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                List<MyPetReport> allPetReports = mPetReportFacade.findAll();
                
                request.setAttribute("reportList", allPetReports);
                request.getRequestDispatcher("PetReports.jsp").include(request,response);
