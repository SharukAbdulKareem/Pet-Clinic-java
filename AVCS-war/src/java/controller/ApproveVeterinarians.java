 ...
 * @author sharuk
 */
@WebServlet(name = "ApproveVeterinarians", urlPatterns = {"/ApproveVeterinarians"})
public class ApproveVeterinarians extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                MyVeterinary found = myVeterinaryFacade.find(Long.parseLong(vetId));
                ...
                out.println("<br><br>Sorry " + vetId  + ", invalid input");
            }
