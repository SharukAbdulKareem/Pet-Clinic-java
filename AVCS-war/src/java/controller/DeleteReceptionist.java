 ...
 * @author sharuk
 */
@WebServlet(name = "DeleteReceptionist", urlPatterns = {"/DeleteReceptionist"})
public class DeleteReceptionist extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        MyReceptionist removedRecep =  myReceptionistFacade.find(Long.parseLong(receptionistId));
        ...
        try{
            ...
            if(receptionistId != null && !receptionistId.isEmpty()){
                ...
                if(removedRecep != null){
                myReceptionistFacade.remove(removedRecep);
//                response.sendRedirect(request.getContextPath() + "/dashboardStaff2.jsp");
