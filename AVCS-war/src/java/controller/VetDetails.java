 ...
 * @author sharuk
 */
@WebServlet(name = "VetDetails", urlPatterns = {"/VetDetails"})
public class VetDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                request.setAttribute("VeterinaryList", allVets);
                request.getRequestDispatcher("VeterinarianTable.jsp").include(request,response);
